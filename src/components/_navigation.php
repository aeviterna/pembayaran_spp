...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        <li class="nav-item d-none d-sm-inline-block">
            <a class="nav-link">
                <?php echo ucwords(SessionManager::get("username") ? $username = SessionManager::get("username") : $username = SessionManager::get("nisn")); ?>
                Sebagai
                <?php echo ucwords($roleManager->getRoleName(SessionManager::get("role"))); ?>
            </a>
        </li>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu"
                ...
                foreach ($pageArray as $page) {
                    ...
                    if ($page["child"] != null) {
                        ...
                        foreach ($page["child"] as $child) {
                            echo "<li class='nav-item'>";
                            echo "<a href='" . $child["link"] . "' class='nav-link " . (str_contains($_SERVER["REQUEST_URI"], $child["link"]) ? "active" : "") . "'>";
