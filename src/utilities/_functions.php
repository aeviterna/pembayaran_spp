...
$routes = [
    ...
    'petugas' => '/' . Configuration::BASE_URL . '/src/models/pengguna/petugas/index.php',
    'petugas_tambah' => '/' . Configuration::BASE_URL . '/src/models/pengguna/petugas/petugas_tambah.php',
    'petugas_ubah' => '/' . Configuration::BASE_URL . '/src/models/pengguna/petugas/petugas_ubah.php?id={id}',
    'petugas_hapus' => '/' . Configuration::BASE_URL . '/src/models/pengguna/petugas/petugas_hapus.php?id={id}',
    'petugas_ubah_password' => '/' . Configuration::BASE_URL . '/src/models/pengguna/petugas/petugas_ubah_password.php?id={id}',
    'siswa' => '/' . Configuration::BASE_URL . '/src/models/pengguna/siswa/index.php',
    'siswa_tambah' => '/' . Configuration::BASE_URL . '/src/models/pengguna/siswa/siswa_tambah.php',
    'siswa_ubah' => '/' . Configuration::BASE_URL . '/src/models/pengguna/siswa/siswa_ubah.php?id={id}',
    'siswa_hapus' => '/' . Configuration::BASE_URL . '/src/models/pengguna/siswa/siswa_hapus.php?id={id}',
    'siswa_ubah_password' => '/' . Configuration::BASE_URL . '/src/models/pengguna/siswa/siswa_ubah_password.php?id={id}',
