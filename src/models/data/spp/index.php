...
$result = $databaseManager->read("spp", "*", "dihapus='0'",
        "ORDER BY tahun ASC");
$result = $result->fetch_all(MYSQLI_ASSOC);

$result_count = $databaseManager->read("spp", "COUNT(id_spp) AS total_spp", "dihapus='0'");
                        ...
                        [
                                ...
                                "child" => [
                                        [
                                                "id"    => 1,
                                                "title" => "Total SPP",
                                                "value" => $result_count->fetch_assoc()['total_spp'],
                                        ...
                                        <table id="main-table" class="table table-bordered table-stripped table-sm">
                                            ...
                                            <tr>
                                                <td class='text-center align-middle'><?php
                                                    echo $tahun; ?></td>
                                                <td class='text-center align-middle'>Rp. <?php
                                                    echo $nominal_formatted; ?></td>
                                                <td class='text-center align-middle'>
                                                    <div class="btn-group">
                                                        <a class="btn btn-app bg-warning m-0"
                                                           href="<?php
                                                           echo UtilsManager::generateRoute('spp_ubah',
                                                                   ['id' => $id]); ?>"
                                                        >
                                                        ...
                                                        <a class="btn btn-app bg-danger m-0"
                                                           ...
                                                           href="<?php
                                                           echo UtilsManager::generateRoute('spp_hapus',
                                                                   ['id' => $id]); ?>">
