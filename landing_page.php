...
<section id="hero-animated" class="hero-animated d-flex align-items-center">
    <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative"
         data-aos="zoom-out">
        <img src="src/images/undraw_Mobile_payments_re_7udl.png" class="img-fluid animated">
        <h2>
            Konfirmasi Pembayaran SPP dan Riwayat Pembayaran Secara Online
        </h2>
        <p>
        ...
        <div class="d-flex">
            <a href="src/models/auth/login_siswa.php" class="btn-get-started scrollto">Login sebagai Siswa</a>
